...
#define BUILD_VARIANT_LABEL "pa3q-S938BXXS5AYG2-app-p0-baseline"
...
#if defined(APP_PAYLOAD) && APP_PAYLOAD
/* Device-tested pa3q-S938BXXS5AYG2 race and gate parameters. */
