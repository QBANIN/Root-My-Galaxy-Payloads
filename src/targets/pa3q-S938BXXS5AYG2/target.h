...
#define BUILD_VARIANT_LABEL "pa3q-S938BXXS5AYG2-app-physical-p0-oracle"
...
#define P0_FINGERPRINT_HEADER \
  "targets/pa3q-S938BXXS5AYG2/p0_fingerprint.h"
#endif
...
/* Symbol offsets from kernel image base (KIMAGE_TEXT_BASE) */
/* NOTE: These are derived from S938NKSUACZF1 profile as baseline.
 * For kernel 6.6.x on pa3q, exact offsets must be verified against
 * the actual target kernel symbols or BTF data. */

#define ASHMEM_MISC_FOPS_OFF 0x02454ff8ULL
#define ASHMEM_FOPS_OFF 0x013e2c48ULL
#define ASHMEM_IOCTL_OFF 0x00d48604ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d48cc0ULL
#define ASHMEM_MMAP_OFF 0x00d48d14ULL
#define ASHMEM_OPEN_OFF 0x00d48f34ULL
#define ASHMEM_RELEASE_OFF 0x00d48fbcULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d49048ULL
...
/* Convenience macros combining base + offset */
...
/* Slide oracle offsets - nf_logger and boot_id manipulation */
...
/* struct file_operations member offsets (from BTF analysis of this kernel) */
/* This kernel has additional fields vs older versions: iopoll, mmap_supported_flags,
 * splice_eof, copy_file_range, remap_file_range, fadvise, uring_cmd, uring_cmd_iopoll */
...
#define FOPS_IOPOLL_OFF 0x30
#define FOPS_ITERATE_SHARED_OFF 0x38
